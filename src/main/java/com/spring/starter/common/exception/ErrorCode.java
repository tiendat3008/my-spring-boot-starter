...
public enum ErrorCode {
    ...
    PASSWORD_NOT_CHANGED(
            "PASSWORD_NOT_CHANGED", "New password must be different from current password", HttpStatus.BAD_REQUEST),

    OAUTH_PROVIDER_UNSUPPORTED("OAUTH_PROVIDER_UNSUPPORTED", "Unsupported social provider", HttpStatus.BAD_REQUEST),
    OAUTH_EXCHANGE_FAILED(
            "OAUTH_EXCHANGE_FAILED", "Failed to exchange OAuth authorization code", HttpStatus.BAD_GATEWAY),
    ...
    INVALID_AVATAR_URL_SIZE(
            "INVALID_AVATAR_URL_SIZE", "{field} must be at most {max} characters", HttpStatus.BAD_REQUEST),
    INVALID_PREFERRED_LANGUAGE_SIZE(
            "INVALID_PREFERRED_LANGUAGE_SIZE", "{field} must be at most {max} characters", HttpStatus.BAD_REQUEST),
    INVALID_PREFERRED_CURRENCY_SIZE(
            "INVALID_PREFERRED_CURRENCY_SIZE", "{field} must be at most {max} characters", HttpStatus.BAD_REQUEST),
    ...
    SOCIAL_ACCOUNT_ALREADY_LINKED(
            "SOCIAL_ACCOUNT_ALREADY_LINKED", "Social account already linked for this provider", HttpStatus.BAD_REQUEST),
    SOCIAL_ACCOUNT_ALREADY_USED(
            "SOCIAL_ACCOUNT_ALREADY_USED", "Social account is linked with another user", HttpStatus.BAD_REQUEST),
    ...
    PRESIGNED_URL_GENERATION_FAILED(
            "PRESIGNED_URL_GENERATION_FAILED", "Failed to generate pre-signed URL", HttpStatus.INTERNAL_SERVER_ERROR),
