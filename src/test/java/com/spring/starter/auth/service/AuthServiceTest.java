...
class AuthServiceTest {
    ...
    void listSessions_shouldReturnUserSessions() {
        ...
        when(refreshTokenService.getSessionMetadata("session-1"))
                .thenReturn(
                        new SessionMetadata("203.0.113.5", "Chrome", java.time.Instant.parse("2026-03-23T10:15:30Z")));
        when(refreshTokenService.getSessionMetadata("session-2"))
                .thenReturn(new SessionMetadata(
                        "198.51.100.7", "Firefox", java.time.Instant.parse("2026-03-23T11:15:30Z")));
    ...
    void authenticate_shouldStoreSessionMetadata_whenCredentialsValid() {
        ...
        verify(refreshTokenService)
                .storeRefreshToken(
                        ...
                        org.mockito.ArgumentMatchers.argThat(metadata -> metadata != null
